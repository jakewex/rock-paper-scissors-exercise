...
if usermove not in options:
    ...
    if cpumove == usermove:
        print(x, " and computer both chose", usermove)
        print("Please try again to determine a winner")
    elif cpumove == "rock":
        if usermove == "paper":
            print(x, " chose paper. Computer chose rock. User wins!")
            print("Please play again!")
        elif usermove == "scissors":
            print(x, " chose scissors. Computer chose rock. Computer wins!")
            print("Please play again!")
    elif cpumove == "paper":
        if usermove == "rock":
            print(x, " chose rock. Computer chose paper. Computer wins!")
            print("Please play again!")
        elif usermove == "scissors":
            print(x, " chose scissors. Computer chose paper. User wins!")
            print("Please play again!")
    elif cpumove == "scissors":
        if usermove == "paper":
            print(x, " chose paper. Computer chose scissors. Computer wins!")
            print("Please play again!")
        elif usermove == "rock":
            print(x, " chose rock. Computer chose scissors. User wins!")
            print("Please play again!")